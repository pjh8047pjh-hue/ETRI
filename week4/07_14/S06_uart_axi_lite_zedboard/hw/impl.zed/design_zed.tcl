...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set uart_cts [ create_bd_port -dir I uart_cts ]
  set uart_rts [ create_bd_port -dir O -from 0 -to 0 uart_rts ]
  ...
  # Create instance: uart_axi_lite_0, and set properties
  set block_name uart_axi_lite
  set block_cell_name uart_axi_lite_0
  if { [catch {set uart_axi_lite_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $uart_axi_lite_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_intf_net -intf_net axi4_to_lite_0_m_axil [get_bd_intf_pins axi4_to_lite_0/m_axil] [get_bd_intf_pins uart_axi_lite_0/s_axi_lite]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M01_AXI [get_bd_intf_pins axi4_to_lite_0/s_axi] [get_bd_intf_pins smartconnect_0/M01_AXI]

  # Create port connections
  connect_bd_net -net proc_sys_reset_0_interconnect_aresetn [get_bd_pins axi4_to_lite_0/axi_aresetn] [get_bd_pins proc_sys_reset_0/interconnect_aresetn] [get_bd_pins smartconnect_0/aresetn]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins uart_axi_lite_0/aresetn]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi4_to_lite_0/axi_aclk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins smartconnect_0/aclk] [get_bd_pins uart_axi_lite_0/aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N]
  connect_bd_net -net uart_axi_lite_0_uart_tx [get_bd_ports uart_txd] [get_bd_pins uart_axi_lite_0/uart_tx]
  connect_bd_net -net uart_rxd_1 [get_bd_ports uart_rxd] [get_bd_pins uart_axi_lite_0/uart_rx]
  connect_bd_net -net xlconstant_0_dout [get_bd_ports uart_rts] [get_bd_pins xlconstant_0/dout]

  # Create address segments
  assign_bd_address -offset 0x60000000 -range 0x00100000 -target_address_space [get_bd_addr_spaces axi4_to_lite_0/m_axil] [get_bd_addr_segs uart_axi_lite_0/s_axi_lite/reg0] -force
  assign_bd_address -offset 0x60000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi4_to_lite_0/s_axi/reg0] -force
