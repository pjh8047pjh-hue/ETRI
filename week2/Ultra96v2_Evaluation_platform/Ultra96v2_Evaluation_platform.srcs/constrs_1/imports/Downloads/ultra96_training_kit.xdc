...
set_property PACKAGE_PIN L2   [get_ports {clk_in	                  }];  # "L2.CSI0_D3_P"
...
# ---------------------------------------------------------------------------- 
# Bank 26
set_property PACKAGE_PIN D7   [get_ports {rst               }];  # "D7.HD_GPIO_0"
...
set_property PACKAGE_PIN G6   [get_ports {led               }];  # "G6.HD_GPIO_8"
