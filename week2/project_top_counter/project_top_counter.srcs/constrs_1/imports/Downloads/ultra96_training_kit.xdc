...
# ---------------------------------------------------------------------------- 
# Bank 65
set_property PACKAGE_PIN F1   [get_ports {start               }];  # "F1.DSI_D0_N"
set_property PACKAGE_PIN G1   [get_ports {rst                 }];  # "G1.DSI_D0_P"
set_property PACKAGE_PIN E3   [get_ports {hold                }];  # "E3.DSI_D1_N"
...
# ---------------------------------------------------------------------------- 
# Bank 26
set_property PACKAGE_PIN D7   [get_ports {ssd2[6]               }];  # "D7.HD_GPIO_0"
set_property PACKAGE_PIN F8   [get_ports {ssd2[5]               }];  # "F8.HD_GPIO_1"
