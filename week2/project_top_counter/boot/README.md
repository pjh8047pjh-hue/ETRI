# boot — project_top_counter 비트스트림

Vivado 생성물(project_top_counter.runs 등)은 용량 정리로 삭제했지만,
...
`project_top_counter.xpr`을 Vivado 2020.2에서 열고 Generate Output Products 후
