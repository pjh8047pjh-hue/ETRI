...
set_property PACKAGE_PIN F8   [get_ports {tx_data               }];  # "F8.HD_GPIO_1"
set_property PACKAGE_PIN F7   [get_ports {rx_data               }];  # "F7.HD_GPIO_2"
...
# Pmod96 U6 온보드 오실레이터는 40MHz.
# clk_wiz_0가 입력 clock constraint(25ns)를 자동 생성한다.
